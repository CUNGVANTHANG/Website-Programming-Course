const contentBody = `<div nh-row="x1rviay" class="">
		  ...
		  <div class="row">
			<div class="col-md-12 col-12">
			  <nav class="breadcrumbs__content">
				<div class="breadcrumbs__item"><a href="/">Trang chủ</a></div>
				<div class="breadcrumbs__item"><a href="/member/change-email" class="active">Tài khoản thành viên</a></div>
			  </nav>
			</div>
		  </div>
		</div>
		...
		<div class="row justify-content-center">
		  <div class="col-md-5 col-12">
			<div class="mb-60 rounded bg-white shadow p-30 session-change session-otp">
			  <form nh-form="change-email" class="contact-form" action="/member/ajax-change-email" method="post" autocomplete="off" novalidate="novalidate">
				<h3 class="text-24 lh-13 mb-25">Thay đổi email</h3>
				...
				<div class="form-group mb-15">
				  <label for="new_email" class="text-14 lh-1 fw-500 text-dark-1 mb-10">
					Email mới:
					<span class="required">*</span>
				  </label>
				...
				<div class="form-group">
				  <span nh-btn-action="submit" class="button -md -dark-1 text-white"> Xác nhận </span>
				</div>
			  </form>
			</div>
		  </div>
